...
## Версионность
Текущая версия: v0.13.0 (последний тег; ТЗ-1 от 2026-09-19 на security/tz-фиксы уже
смёржена в main, но тег на неё сознательно не ставили — ждём завершения остальной
работы дня и один общий тег). Теги обычно ставит Алексей вручную:
